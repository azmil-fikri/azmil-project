...
<div class="main-content">
  <section class="section">
    ...
    <div class="card mt-4">
      <form action="{{ route('distributor.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
        @csrf
        <div class="card-body">
          <div class="row">
            <div class="col-6">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="email" id="email" cols="30" rows="40" required></textarea>
                <div class="invalid-feedback">
