...
<div class="main-content">
  <section class="section">
    ...
    <div class="card mt-4">
      <form action="{{ route('flashsale.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
        @csrf
        <div class="card-body">
          <div class="row">
            <div class="col-6">
            ...
            <div class="col-6">
              <div class="form-group">
                <label for="price">Harga Produk Flashsale (Point)</label>
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <div class="invalid-feedback">
                  Deskripsi Flashsale harus diisi!
                </div>
              </div>
            </div>
            <div class="col-12">
